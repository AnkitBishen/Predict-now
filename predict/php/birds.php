...
<body>
    <center>
        <br>
        <h1>Predicte Now</h1>
        <h3>choose atleast one Birds between these</h3>
        <div>
        <ul>
            <li>Peahen</li>
            <li>Crow</li>
        ...
        <form action="" method="post">
            <input type="text" name="text_color" id="text-id" placeholder="Enter your Bird name">
        ...
        <h2>
            <?php
                if(isset($_POST['submit'])){
                    $my_color = array("Peahen", "Crow", "Owl","Hen", "Swans", "Eagle", "Sparrow", "Duck","Kiwi", "Kite", "Crane", "Kingfisher");
                    shuffle($my_color);
